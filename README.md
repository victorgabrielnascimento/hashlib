# hashlib
Hash password sistem with a menu for register and login made with python!

### Hello dev!!

<br>

## Welcome to my hash password project! You can use this project to hash a user password for keep data safe from a data leak!

<br>
<p>It was suppost to me use this password hash as school purpose, but the project was a cool experience, so I decide to let this in a repositórie for every one that want to test and use for school purpose too!!</p>
...
![down](https://github.com/victorgabrielnascimento/TextScanner/assets/105366808/45d4211f-dc59-4e12-a205-7a64fa1e3816)
 ...
 <br>
   ...
   <p>Now all you need is execute the program, be free to change user and password! Check the db.txt, there will be possible to you check how the hash will save your hash password in db!</p>
